...
impl StubOracle {
    pub fn load_mut_checked<'a>(
        ...
        check_eq!(account.data_len(), size_of::<Self>(), LyraeErrorCode::Default)?;
...
impl Product {
    pub fn get_product<'a>(account: &'a AccountInfo) -> LyraeResult<Product> {
...
impl Price {
    pub fn get_price<'a>(account: &'a AccountInfo) -> LyraeResult<Price> {
        let borrowed = &account.data.borrow();
