...
use lyrae_logs::{lyrae_emit, PerpBalanceLog};
...
pub fn emit_perp_balances(
    lyrae_group: Pubkey,
    lyrae_account: Pubkey,
    market_index: u64,
    pa: &PerpAccount,
    perp_market_cache: &PerpMarketCache,
) {
    lyrae_emit!(PerpBalanceLog {
        lyrae_group: lyrae_group,
        lyrae_account: lyrae_account,
